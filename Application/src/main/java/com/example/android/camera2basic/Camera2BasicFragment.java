...
import com.example.android.camera2basic.sound.SoundClips;
...
public class Camera2BasicFragment extends Fragment
    ...
    private CaptureRequest.Builder mZSLRequestBuilder;
    private CaptureRequest mPreviewRequest;
    private CaptureRequest mZSLRequest;
    ...
    public void onResume() {
        ...
        mSoundPlayer = SoundClips.getSoundPoolPlayer(getContext());
    ...
    private void releasemSoundPlayer(){
    ...
    private void takePicture() {
        mSoundPlayer.play(SoundClips.CAMERA_SHUTTER_SOUND_ID);
        Log.d(TAG, "---->>>takePicture: play sound");
        lockFocus();
    }

    private void testTakePictureZsl(){
        try {
            CaptureRequest.Builder stillRequestBuilder =
                    mCameraDevice.createCaptureRequest(CameraDevice.TEMPLATE_STILL_CAPTURE);
            // enable zsl control
            stillRequestBuilder.set(CaptureRequest.CONTROL_ENABLE_ZSL, true);
            stillRequestBuilder.addTarget(mPreviewSurface);
    ...
    private static class ImageSaver implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                output.write(bytes);
                Log.d(TAG, "--->>>testTakePictureZsl run: save file = " + mFile.getAbsolutePath());
            } catch (IOException e) {
                e.printStackTrace();
            } finally {
                mImage.close();
